 ...
 * Original file: Z:\\id_kemaoming\\apk\\Dreamer\\src\\com\\dreamer\\tool\\download\\IDownloadService.aidl
 */
package com.dreamer.tool.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.dreamer.tool.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.dreamer.tool.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.dreamer.tool.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.dreamer.tool.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.dreamer.tool.download.IDownloadService))) {
return ((com.dreamer.tool.download.IDownloadService)iin);
}
return new com.dreamer.tool.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.dreamer.tool.download.IDownloadService
{
