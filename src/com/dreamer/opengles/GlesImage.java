...
public class GlesImage extends GlesObject {
	...
	protected int maNormalHandle;// 閿熸枻鎷烽敓濮愭硶閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
	protected int maLightLocationHandle; // 閿熸枻鎷锋簮浣嶉敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
	protected int maCameraHandle;// 閿熸枻鎷烽敓鏂ゆ嫹閿熻娇浼欐嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿燂拷
	protected int maTextCoorHandle;// 閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓锟�
									// protected static int
									// maLightDirectionHandle; //
									// 閿熸枻鎷锋簮浣嶉敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
	protected float[] vertices;
	protected float[] colors;
	protected float[] textCoor = new float[] { 0.f, 0.f, 0.f, 1.f, 1.f, 0.f,
			1.f, 1.f };
	// protected float[] textCoor = new float[] { 0.f, 0.f, 0.f, 0.5f, 0.5f,
	// 0.f,
	// 0.5f, 0.5f };
	...
	private String TAG = GlesImage.class.getSimpleName();
	...
	public GlesImage(Context ctx, float width, float height) {
		super();
		this.width = width;
		this.height = height;
		this.context = ctx;
	...
	public GlesImage(Context ctx, int width, int height) {
		super();
	...
	private void initShader() {
		...
		if (isFirst) {
			...
			mProgram = GlesToolkit.createProgram(
					GlesImage.class.getSimpleName(), mVertexShader,
					mFragmentShader);
			if (mProgram == 0) {
	...
	public boolean onDraw() {
		synchronized (mutex) {
			if (update) {
				...
				if (bitmap != null) {
					textureId = GlesToolkit.genTexture(bitmap,
							GlesToolkit.WRAP_ST_REPEAT, GLES20.GL_NEAREST,
							GLES20.GL_LINEAR, isRecycle);
